...
class ForumListRequest extends APIRequest with StartLoading {
  ...
  @override
  CreateSuccess get goodResponse => (list) => ForumListSuccess(this, list);
}
...
class ForumInfoRequest extends APIRequest with StartLoading {
  ...
  @override
  CreateSuccess get goodResponse => (info) => ForumInfoSuccess(this, info);
}
...
class ForumStoryRefreshRequest extends ForumStoryRequest {
  ...
  CreateFailure get badResponse =>
      (error) => ForumStoryRefreshFailure(this, error);
...
class ForumStoryLoadMoreRequest extends ForumStoryRequest {
  ...
  @override
  CreateFailure get badResponse =>
      (error) => ForumStoryLoadMoreFailure(this, error);
...
class ForumStoryCheckNewRequest extends APIRequest {
  ...
  @override
  CreateFailure get badResponse =>
      (error) => ForumStoryCheckNewFailure(this, error);
