...
class HomeListNewRequest extends HomeListRequest {
  ...
  @override
  CreateSuccess get goodResponse => (list) => HomeListNewSuccess(this, list);
}
...
class HomeListRefreshRequest extends HomeListRequest {
  ...
  CreateFailure get badResponse =>
      (error) => HomeListRefreshFailure(this, error);
...
class HomeListLoadMoreRequest extends HomeListRequest {
  ...
  @override
  CreateFailure get badResponse =>
      (error) => HomeListLoadMoreFailure(this, error);
...
class HomeListCheckNewRequest extends APIRequest {
  ...
  @override
  CreateFailure get badResponse =>
      (error) => HomeListCheckNewFailure(this, error);
...
class StoryContentRequest extends APIRequest with StartLoading {
  ...
  @override
  CreateSuccess get goodResponse => (list) => StoryContentSuccess(this, list);
}
...
class StoryInfoRequest extends APIRequest with StartLoading {
  ...
  @override
  CreateSuccess get goodResponse => (list) => StoryInfoSuccess(this, list);
}
